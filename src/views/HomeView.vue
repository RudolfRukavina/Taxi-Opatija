...
.footer-border {
  ...
  background: linear-gradient(0deg, rgba(0, 29, 180, 0.0970982142857143) 0%, rgba(0, 159, 180, 0.09429709383753504) 100%);
}
...
.hero-hours {
  ...
  background: linear-gradient(0deg, rgba(0, 153, 180, 0.9990589985994398) 0%, rgba(0, 114, 180, 1) 100%);
  border-radius: 23px;
